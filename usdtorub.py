...
amount = input('Введите сумму USD, которую необходимо конвертировать в RUB.') #Запрос пользователю на ввод сумму к конвертации
convertRUBToUSD(amount) #Выполнение функции